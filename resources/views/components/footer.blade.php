    ...
    <div class="container px-6 py-4 mx-auto">
        <div class="flex justify-around">
            <div class="flex items-center">
                ...
                <p class="antialiased font-bold text-black mx-2 text-xl">ekinoxproduct</p>
            </div>
            <div class="flex items-center">
                <svg class="fill-current text-verde bg-white rounded-full" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        ...
        <div>
            <p class="text-center text-black dark:text-white">© Ekinox Products 2022 - Todos los Derechos Reservados.</p>
        </div>
    </div>
</footer>