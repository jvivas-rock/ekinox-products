...
<div class="flex flex-no-wrap">
    ...
    <main class="container w-4/5 bg-white max-h-screen overflow-y-scroll">
    ...
    <div class="container px-6 py-4 mx-auto">
        <div class="flex justify-around">
            <div class="flex flex-col items-center">
            	<div>
                	<p class="antialiased uppercase text-white mx-2 text-xl">Contact Info: <strong>Douglas Serrano</strong></p>
                </div>
                <div>
                	<p class="antialiased text-white mx-2 text-xl">Sales & Marketing Director</p>
                </div>
                <div>
                	<a href="mailto:dserranom@ekinoxproducts.com" class="antialiased text-white mx-2 text-xl hover:underline">dserranom@ekinoxproducts.com</a>
                </div>
            </div>
            <div class="flex flex-col items-center">
            	<div class="flex items-center">
                	...
                	<p class="antialiased font-bold text-white mx-2 text-xl">+593 985584313</p>
